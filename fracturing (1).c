...
// Purpose: The purpose of this program is to gather user input of two coordinates and calculate the distance, area, perimeter, 
// width and height of the given circle generated. By implementing the practice of fractures into the program to break them up.
// Input: None
